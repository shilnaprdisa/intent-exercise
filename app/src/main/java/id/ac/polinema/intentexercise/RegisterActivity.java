...
public class RegisterActivity extends AppCompatActivity {
    private TextInputLayout etname, etEmail, etPassword, etConfirmPassword, etHomepage, etAbout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etname = findViewById(R.id.layout_fullname);
        etEmail = findViewById(R.id.layout_email);
        etPassword = findViewById(R.id.layout_password);
        etConfirmPassword = findViewById(R.id.layout_confirm_password);
        etHomepage = findViewById(R.id.layout_homepage);
        etAbout = findViewById(R.id.layout_about);
        ...
        button2 = findViewById(R.id.button_ok);
